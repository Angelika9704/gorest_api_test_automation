...
import pl.globallogic.gorest.model.CreateUserRequest;

import static io.restassured.RestAssured.*;

public class UserApiCrudBasicVerificationTest extends BaseApiTest {
    private static final String ENDPOINT = "/users";
    private static final String token = "fb2f0a756abc1616c18cca91c2252aae29099998edb734e7d5dd0c30c94f653b";

    private String ourUserId;
    @BeforeMethod
    public void testSetUp(){
        String randomEmail = getRandomEmail();
        CreateUserRequest userPayLoad = new CreateUserRequest("Nick Nacks", randomEmail, "male","active");
        Response resp = given().
                body(userPayLoad).
    ...
    private static String getRandomEmail() {
        String email = (int) (Math.random() * 2000) + "@examplemail.com";
    ...
    public void shouldUpdateExistingUserWithNewData(){
        String randomEmail = getRandomEmail();
        CreateUserRequest userPayLoad = new CreateUserRequest("Nick Nacks", randomEmail, "male","inactive");
        given().
